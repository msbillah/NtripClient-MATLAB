function goGPS_master_monitor(filerootOUT, flag_NTRIP, ntripinfo)
...
master_ip = ntripinfo.master_ip;
master_port = ntripinfo.master_port;
ntrip_user = ntripinfo.ntrip_user;
ntrip_mountpoint = ntripinfo.ntrip_mountpoint;
ntrip_pw = ntripinfo.ntrip_pw;

nmea_init = ntripinfo.nmea_init;
nmea_update_rate = ntripinfo.nmea_update_rate;
master = ntripinfo.master;
server_delay = ntripinfo.server_delay;
...
if (flag_NTRIP)
    ntripstring = NTRIP_string_generator(nmea_init, master_ip, ntrip_user, ntrip_pw, ntrip_mountpoint);
